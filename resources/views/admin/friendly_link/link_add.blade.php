        ...
        <div class="col-lg-12">
            <section class="panel">
                <div class="panel-body">
                    <form class="form-horizontal adminex-form" method="post" action="{{to_route('admin.friendly_link.append')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group {{ $errors->has('attr_title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                    <input title="" name="website" type="text" class="form-control" value="" required >
                        ...
                        <div class="form-group {{ $errors->has('attr_title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <input title="" name="weburl" type="text" class="form-control" value="" required >
                                <span class="help-block">例如： title=""</span>
                                <span class="help-block">{{ $errors->first('attr_title') }}</span>
                            </div>
                        </div>
                        <div class="form-group {{ $errors->has('attr_title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <input title="" name="email" type="text" class="form-control" value="" required >
                                <span class="help-block">例如： title=""</span>
                                <span class="help-block">{{ $errors->first('attr_title') }}</span>
                            </div>
                        </div>
                        <div class="form-group {{ $errors->has('attr_title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <input title="" name="sort" type="text" class="form-control" value="" required >
                                <span class="help-block">例如： title=""</span>
                                <span class="help-block">{{ $errors->first('attr_title') }}</span>
                            </div>
                        </div>
